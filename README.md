...
Я пишу **программы, которые не зависят**:
...
- Нет перемешений данных на холсте
- Fps регулируется одной константой установленной сейчас в 20мс адаптивной задержки что даёт 50Гц
