...
**программы, которые не зависят**:
- Ни от операционной системы (sys_*.c — для демонстрации на текущих осях)
- Ни от видеокарты  (Fps — просто константа `Delay_ms(Fps)`)
- Ни от процессора (32/64/128... бит — автоадаптация)
- Ни от монитора (8k/16k/32k... — автоадаптация)
- Ни от страны (UTF8 — полная поддержка без библиотек)
- Ни от «экосистем» (NoLibs — лишнее)
